...
const AdminDiagnostics = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            <AnimatePresence>
                {isModalOpen && (
                    <div className="fixed inset-0 md:left-64 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
                        <motion.div
                            initial={{ opacity: 0, scale: 0.95 }}
                            animate={{ opacity: 1, scale: 1 }}
                        ...
                        >
                            ...
                            <h3 className="font-cabinet font-bold text-2xl text-white mb-6 shrink-0">
                                {previewUrl ? 'Visualizar Diagnóstico' : editingUser ? 'Editar Diagnóstico' : 'Novo Diagnóstico'}
                            </h3>

                            {previewUrl ? (
                                <div className="flex-1 w-full bg-black rounded-2xl overflow-hidden border border-white/10">
                                    <iframe
                                        src={previewUrl}
