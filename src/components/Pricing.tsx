            ...
            <div className="container mx-auto px-4 relative z-10 max-w-6xl">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-6">
                        ...
                        <span className="text-xs font-bold tracking-widest uppercase text-white/80">{t('pricing.badge')}</span>
                    </div>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        <h2 className="font-cabinet font-bold text-6xl md:text-8xl leading-none tracking-tighter text-white mb-8 flex flex-col">
                            <span>{t('pricing.offer_line1')}</span>
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">{t('pricing.offer_line2')}</span>
                        </h2>
                        ...
                        <div className="relative z-10">
                            <div className="mb-8">
                                <div className="flex items-center gap-4 mb-2">
                                    ...
                                    <h3 className="text-3xl font-bold text-white">{t('pricing.card.title')}</h3>
                                </div>
                                <h4 className="text-xl font-bold text-white mb-4 pl-[4rem]">{t('pricing.card.subtitle')}</h4>
                            ...
                            <button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4 rounded-full font-bold text-sm uppercase tracking-widest flex items-center justify-center gap-2 hover:scale-[1.02] transition-transform duration-300 shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] mb-10 hover:brightness-110">
                                {t('pricing.card.button')} <ArrowUpRight size={18} />
                            </button>

                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <Check className="text-white w-5 h-5" />
                                    <span className="text-gray-300 text-sm">{t('pricing.feat1')}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Check className="text-white w-5 h-5" />
                                    <span className="text-gray-300 text-sm">{t('pricing.feat2')}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Check className="text-white w-5 h-5" />
                                    <span className="text-gray-300 text-sm">{t('pricing.feat3')}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Check className="text-white w-5 h-5" />
                                    <span className="text-gray-300 text-sm">{t('pricing.feat4')}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Check className="text-white w-5 h-5" />
                                    <span className="text-gray-300 text-sm">{t('pricing.feat5')}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Check className="text-white w-5 h-5" />
                                    <span className="text-gray-300 text-sm">{t('pricing.feat6')}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Check className="text-white w-5 h-5" />
                                    <span className="text-gray-300 text-sm">{t('pricing.feat7')}</span>
                                </div>
                            </div>
                        </div>
                    </motion.div>
