        ...
        <section id="careers" className="py-24 bg-human-bg font-satoshi border-t border-white/5">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-12">
                    ...
                    >
                        O QUE <br />
                        VOCÊ VAI <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">RECEBER</span>
                    </motion.h2>
                    ...
                    >
                        <a
                            ...
                            className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-full font-bold text-lg transition-all transform hover:-translate-y-1 shadow-[0_0_20px_rgba(168,85,247,0.5)] hover:shadow-[0_0_30px_rgba(168,85,247,0.7)] hover:brightness-110"
                        >
