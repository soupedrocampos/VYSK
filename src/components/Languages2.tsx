    ...
    return (
        <section className="relative w-full h-[1100px] md:h-[1300px] bg-black overflow-hidden flex flex-col items-center justify-center font-satoshi perspective-[1000px]">
            ...
            <div className="relative z-[90] text-center flex flex-col items-center max-w-4xl px-4 pointer-events-none mt-10">
                ...
                <button
                    onClick={openModal}
                    className="pointer-events-auto inline-flex items-center gap-3 px-10 py-5 bg-purple-600 hover:bg-purple-500 text-white rounded-full text-sm font-bold tracking-widest uppercase transition-all duration-300 transform hover:scale-105 shadow-[0_0_30px_rgba(147,51,234,0.5)] hover:shadow-[0_0_50px_rgba(147,51,234,0.8)] border border-purple-400/30 mb-20"
                >
