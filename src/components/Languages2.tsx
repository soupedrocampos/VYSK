...
const Languages2 = () => {
    const { t } = useLanguage();
    return (
        <section className="relative w-full h-[900px] bg-black overflow-hidden flex flex-col items-center justify-center font-satoshi perspective-[1000px]">
            ...
            <div className="relative z-50 text-center flex flex-col items-center max-w-4xl px-4 pointer-events-none">
                ...
                >
                    <h2 className="text-white font-cabinet font-bold text-7xl md:text-8xl leading-none mb-4 drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] tracking-tighter">
                        {t('languages2.title')}
                    </h2>
                    <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-200 to-white font-sans font-normal text-2xl md:text-3xl leading-tight mb-8 drop-shadow-2xl uppercase tracking-[0.2em]">
                    ...
                    {flags.map((flag, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className="absolute inset-0 bg-cover bg-center rounded-xl shadow-[0_0_30px_rgba(255,255,255,0.1)] border border-white/10 opacity-40 blur-[0.5px]"
