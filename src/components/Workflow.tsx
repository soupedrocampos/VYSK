                ...
                <div className="flex justify-between items-end mb-16 relative z-10">
                    <div>
                        <div className="inline-flex items-center space-x-2 mb-4">
                            <h2 className="font-cabinet font-bold text-6xl md:text-8xl leading-none tracking-tighter text-white uppercase mb-6">
                                Workflow <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">N8N</span> <span className="text-4xl align-top">®</span>
                            </h2>
                        </div>
                    </div>
